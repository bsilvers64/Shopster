...
import { selectProducts , fetchAllProductsAsync, fetchProductsByfilterAsync} from "../ProductSlice";
...
export default function ProductList() {
  ...
  // we will now send actions to initialize our products data
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="product-details">
                              <div key={product.id} className="group relative border-2 p-1 border-gray-200">
                                ...
                                <div className="mt-4 flex justify-between">
                                  ...
                                  <div className="flex flex-col">
                                    ...
                                    <p className="text-sm font-medium text-gray-900 text-decoration: line-through">
                                      ${product.price}
                                    </p>
                                  </div>
                                </div>
