...
import { products } from '../features/cart/Cart';
...
const addresses = [
  {
    ...
    city: "Chicago",
    pincode: "23534",
    state: "2023-01-23T13:23Z",
    phone: "123-223-2341",
  },
  {
    name: "peter garfield",
    street: "12 dsfvs road",
    city: "ny",
    pincode: "23534",
    state: "2023-01-23T13:23Z",
    phone: "123-223-2341",
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                  ...
                  {addresses.map((address) => (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-auto">
                        ...
                        <p className="mt-1 truncate text-xs leading-6 text-gray-500">
                          {address.phone}
                        </p>
                      </div>
        ...
        <div className="lg:col-span-2 -mt-12">
          <div className="mx-auto mt-24 max-w-7xl bg-white px-4 py-2 sm:px-0 lg:px-0">
            <div className="border-t border-gray-200 px-4 sm:px-6">
              <h2 className="text-4xl font-bold my-5 tracking-tight text-gray-900 text-left">
                Cart
              </h2>
